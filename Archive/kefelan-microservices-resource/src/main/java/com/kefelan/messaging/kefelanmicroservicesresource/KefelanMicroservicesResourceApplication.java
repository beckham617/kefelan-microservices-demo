package com.kefelan.messaging.kefelanmicroservicesresource;
...
@EnableEurekaClient
@RestController
public class KefelanMicroservicesResourceApplication  extends ResourceServerConfigurerAdapter {

	public static void main(String[] args) {
		SpringApplication.run(KefelanMicroservicesResourceApplication.class, args);
	}
